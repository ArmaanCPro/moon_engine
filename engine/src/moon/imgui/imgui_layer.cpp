...
namespace moon
{
    ...
    void imgui_layer::on_attach()
    {
        ...
        ImGui_ImplGlfw_InitForOpenGL(std::get<GLFWwindow*>(application::get().get_window().get_native_handle()), true);
    ...
    void imgui_layer::begin()
    {
        ...
        if (glfwGetWindowAttrib(std::get<GLFWwindow*>(application::get().get_window().get_native_handle()), GLFW_ICONIFIED) != 0)
        {
